...
public class DisruptorMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Disruptor<Element> myDisruptor = new Disruptor<>(Element::new, 1024, DaemonThreadFactory.INSTANCE);
        myDisruptor.handleEventsWith((event, sequence, endOfBatch) -> System.out.println(event));
        myDisruptor.start();
        myDisruptor.publishEvent((event, sequence) -> event.set(999));
