...
public class HBaseDDL {
    ...
    public static void createNamespace(String namespace) throws IOException {
        ...
        // 2.2 给命令空间添加需求
        builder.addConfiguration("user", "kangjinghang");
...
//            e.printStackTrace();
    ...
    public static void main(String[] args) throws IOException {
        // 创建命名空间
//        createNamespace("kangjinghang");

        // 判断表格是否存在
//        System.out.println(isTableExists("bigdata", "student"));

        // 创建表格
//        createTable("kangjinghang", "student", "info", "msg");

        // 修改表格
//        modifyTable("kangjinghang", "student", "info", 6);

        // 删除表格
        deleteTable("kangjinghang", "student");
