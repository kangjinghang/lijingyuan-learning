...
public class CollectorIntroduce {
    ...
    public static void main(String[] args) {
        ...
        testCounting();
        testGroupByFunction();
        testGroupByFunctionAndThen();
        testGroupByFunctionAndSupplier();
        testSummarizingInt();
    }
...
//        list.add(null);
    ...
    private static void testGroupByFunctionAndThen() {
        System.out.println("testGroupByFunctionAndThen");
    ...
    private static void testGroupByFunctionAndSupplier() {
        System.out.println("testGroupByFunctionAndSupplier");
        Optional.ofNullable(menu.stream().collect(
                Collectors.groupingBy(Dish::getType, TreeMap::new, Collectors.averagingInt(Dish::getCalories))
        )).ifPresent(System.out::println);
    }
